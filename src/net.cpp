...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("TransformersCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("TransformersCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("TransformersCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TransformersCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("TransformersCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("TransformersCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("TransformersCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("TransformersCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TransformersCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("TransformersCoin-start");
