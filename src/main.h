...
static const int LAST_POW_BLOCK = 20200;
...
public:
    ...
    {
        // TransformersCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // TransformersCoin: get transaction coin age
...
public:
    ...
    // TransformersCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // TransformersCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // TransformersCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // TransformersCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // TransformersCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // TransformersCoin: block index flags
    enum  
    {
